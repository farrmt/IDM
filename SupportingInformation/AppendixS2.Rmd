...
This appendix describes the parameter values used in the simulation study. See our [GitHub repository](https://github.com/farrmt/ISDM/tree/master/DataAnalysis/Simulations) for the full code to run the simulation study.
