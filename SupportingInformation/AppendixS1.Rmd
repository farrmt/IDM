...
This appendix describes details on the model structure (Figure S1) and includes additional simulations to evaluate model assumptions. See our [GitHub repository](https://github.com/farrmt/ISDM/tree/master/DataAnalysis/Simulations) for the full code.

![](C:/Users/farrmt/Documents/ISDM/PostAnalysis/DAG.png)
...
filenames <- list.files(path = "Z:/ISDM/Revision/combinedrevisions", pattern = "output", full.names = TRUE)
...
#List of all filenames
filenames <- list.files(path = "Z:/ISDM/Revision/revision3", pattern = "output", full.names = TRUE)
